...
public class EncryptUtil
{
	...
	private static String encode(String secret , String encryptKey) throws NoSuchPaddingException,
	...
	private static String decode(String secret , String encryptKey) throws NoSuchPaddingException,
			NoSuchAlgorithmException, InvalidKeyException, BadPaddingException,
			IllegalBlockSizeException
	{
		if(encryptKey == null || encryptKey.length() == 0)
	...
	public static void main(String[] args){
		...
		try
		{
			...
			String encoded = EncryptUtil.encode("2010-06-25中文也行 13:45:00" );
