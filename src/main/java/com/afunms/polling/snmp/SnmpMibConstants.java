...
public class SnmpMibConstants {
	...
	public static final String[] NetWorkMibInterfaceDesc1={"index","ifHCInOctets","ifHCInMulticastPkts","ifHCInBroadcastPkts",
											"ifInDiscards","ifInErrors","ifHCOutOctets",
											"ifHCOutMulticastPkts","ifHCOutBroadcastPkts","ifOutDiscards","ifOutErrors",
											"ifOutQLen","ifSpecific"
									};
	public static final String[] NetWorkMibInterfaceChname1={"端口索引","接收的字节","单向传输数据包","非单向传输数据包",
											"被丢弃的数据包","入站错误数据包","传输的字节",
	...
	public static final String[] NetWorkMibInterfaceUnit3={"MB","MB","MB"};
	public static final int[] NetWorkMibInterfaceScale2={1,1024,1024};
	public static final int[] NetWorkMibInterfaceScale3={1024*1024*8,1024*1024*8,1024*1024*8};
